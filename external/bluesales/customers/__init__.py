...
class CustomersService:
    ...
    def get(
        ...
        return GetCustomersResponse(response)
    ...
    def get_all_with_step(
        ...
        return [Customer(**obj) for obj in total_items]
